...
| writeBufferTime  | time to write data to buffer | Time spent moving the on heap buffered data read from the file system to off heap memory so the GPU can access it. This is a prt of `bufferTime`                                |
