...
Follow the instructions in [Getting Started with RAPIDS and Kubernetes](https://docs.nvidia.com/cudf-spark/user-guide/latest/getting-started/kubernetes.html)
