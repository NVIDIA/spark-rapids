...
the [Qualification tool](https://github.com/NVIDIA/spark-rapids-tools/blob/dev/core/docs/spark-qualification-tool.md)
and [Profiling tool](https://github.com/NVIDIA/spark-rapids-tools/blob/dev/core/docs/spark-profiling-tool.md)
to analyze them. The Qualification tool outputs the score, rank
