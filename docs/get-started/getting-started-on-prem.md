...
- cudf-21.10.0-SNAPSHOT-cuda11.jar
- rapids-4-spark_2.12-21.10.0-SNAPSHOT.jar
...
export SPARK_CUDF_JAR=${SPARK_RAPIDS_DIR}/cudf-21.10.0-SNAPSHOT-cuda11.jar
export SPARK_RAPIDS_PLUGIN_JAR=${SPARK_RAPIDS_DIR}/rapids-4-spark_2.12-21.10.0-SNAPSHOT.jar
```
