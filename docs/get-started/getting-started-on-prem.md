...
- rapids-4-spark_2.12-22.10.0-SNAPSHOT-cuda11.jar
...
export SPARK_RAPIDS_PLUGIN_JAR=${SPARK_RAPIDS_DIR}/rapids-4-spark_2.12-22.10.0-SNAPSHOT-cuda11.jar
```
...
[NVIDIA GPU Plugin for YARN with MIG support for YARN 3.3.0+](https://github.com/NVIDIA/spark-rapids-examples/tree/branch-22.10/examples/MIG-Support/device-plugins/gpu-mig).
...
See [NVIDIA Support for GPU for YARN with MIG support for YARN 3.1.2 until YARN 3.3.0](https://github.com/NVIDIA/spark-rapids-examples/tree/branch-22.10/examples/MIG-Support/resource-types/gpu-mig)
for details.
