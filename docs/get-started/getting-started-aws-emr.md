...
| --- | --- | --- | ---| --- |
| 6.13 | 3.4.1 | rapids-4-spark_2.12-23.06.0-amzn-1.jar | Bundled with rapids-4-spark | xgboost4j-spark_3.0-1.4.2-0.3.0.jar |
...
Select **emr-6.13.0** for the release and pick "Custom" for the "Application bundle". Uncheck all the 
software options, and then check **Hadoop 3.3.3**, **Spark 3.4.1**, **Livy 0.7.1** and 
