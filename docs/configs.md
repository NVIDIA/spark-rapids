...
<a name="memory.gpu.pooling.strategy"></a>spark.rapids.memory.gpu.pooling.strategy|The strategy to use for the RMM pooling allocator. Valid values are "DEFAULT" and "ARENA".|ARENA
