...
<a name="sql.udfCompiler.enabled"></a>spark.rapids.sql.udfCompiler.enabled|When set to true, all UDFs will be compiled to Catalyst expressions by Catalyst Analyzer.|false
