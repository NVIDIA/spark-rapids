...
<a name="alluxio.home"></a>spark.rapids.alluxio.home|The Alluxio installation home path or link to the installation home path. You can create a link to Alluxio installation path, e.g: ln -s /opt/alluxio-x.y.z /opt/alluxio|/opt/alluxio|Startup
