...
<a name="sql.csv.read.decimals.enabled"></a>spark.rapids.sql.csv.read.decimals.enabled|CSV reading is not 100% compatible when reading decimals.|false
...
<a name="sql.json.read.decimals.enabled"></a>spark.rapids.sql.json.read.decimals.enabled|JSON reading is not 100% compatible when reading decimals.|false
