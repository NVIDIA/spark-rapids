...
<a name="spark.rapids.shuffle.ucx.useSockaddr"></a>spark.rapids.shuffle.ucx.useSockaddr|When set to true, start listener and exchange socket address. This allows better detecting remote peer failures.|false
<a name="spark.rapids.shuffle.ucx.useSockaddr"></a>spark.rapids.shuffle.ucx.usePeerErrHndl|When set to true, enable peer error handling for ucx endpoints. Could impact on a transports and protocols, being selected in ucx.|false
