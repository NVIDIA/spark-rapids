...
<a name="shuffle.enabled"></a>spark.rapids.shuffle.enabled|Enable the RAPIDS Shuffle Manager at runtime. When set to false, the built-in Spark shuffle will be used.|true
