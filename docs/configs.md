...
<a name="sql.expression.CollectList"></a>spark.rapids.sql.expression.CollectList|`collect_list`|Collect a list of elements.|false|This is disabled by default because for now it is only supported by windowing.|
