...
<a name="shuffle.transport.earlyStart"></a>spark.rapids.shuffle.transport.earlyStart|Enable heartbeats for Rapids Shuffle Transport, for early connection establishment|true
<a name="shuffle.transport.earlyStartHeartbeatInterval"></a>spark.rapids.shuffle.transport.earlyStartHeartbeatInterval|Shuffle early start heartbeat interval (milliseconds)|5000
