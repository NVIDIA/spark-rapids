...
<a name="spark.rapids.shuffle.ucx.useSockaddr"></a>spark.rapids.shuffle.ucx.useSockaddr|When set to true, start listener and exchange socket address. This allows better detecting remote peer failures.|true
