...
<a name="sql.castLongToDecimal.enabled"></a>spark.rapids.sql.castLongToDecimal.enabled|Long values which contain more than 18 digits can not be converted to decimal on the GPU, because max supported precision of decimal under GPU is 18.|false
