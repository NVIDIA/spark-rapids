...
<a name="shuffle.ucx.activeMessages.mode"></a>spark.rapids.shuffle.ucx.activeMessages.mode|UCX Active Messages can be RNDV, EAGER, or automatic. We set RNDV by default because version 1.10.x of UCX does not well with EAGER modes (or automatic).|rndv
