...
<a name="memory.gpu.pooling.arena.enabled"></a>spark.rapids.memory.gpu.pooling.arena.enabled|Should RMM use the arena allocator for GPU memory, or should it use the default pooling allocator.|true
