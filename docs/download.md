...
## Release v21.08.0
Starting with release 21.08.0, the project is moving to calendar versioning, with the first two
...
* Download the [RAPIDS cuDF 21.08.1 jar](https://repo1.maven.org/maven2/ai/rapids/cudf/21.08.1/cudf-21.08.1-cuda11.jar)
