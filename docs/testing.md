...
You can include the test jar `rapids-4-spark-integration-tests-0.1-SNAPSHOT.jar` with the
...
```shell script
spark-shell --jars rapids-4-spark-tests_2.12-0.1-SNAPSHOT-tests.jar,rapids-4-spark-integration-tests-0.1-SNAPSHOT-tests.jar,scalatest_2.12-3.0.5.jar,scalactic_2.12-3.0.5.jar
```
