...
nav_order: 1
permalink: /
description: This site serves as a collection of documentation about cuDF for Apache Spark
---
# Overview
...
cuDF for Apache Spark leverages GPUs to accelerate processing via the
...
cuDF for Apache Spark combines the power of the [cuDF](https://github.com/rapidsai/cudf/) library and
the scale of the Spark distributed computing framework.  The cuDF for Spark library also has a
