...
[RapidsUDF](https://github.com/NVIDIA/spark-rapids/blob/main/sql-plugin/src/main/java/com/nvidia/spark/RapidsUDF.java)
...
in the [udf-examples](https://github.com/NVIDIA/spark-rapids/tree/main/udf-examples) project.
