...
<a name="sql.castStringToTimestamp.enabled"></a>spark.rapids.sql.castStringToTimestamp.enabled|When set to false, disable casting from string to timestamp on the GPU.|true|Runtime
