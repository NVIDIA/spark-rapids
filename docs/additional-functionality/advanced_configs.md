...
<a name="io.compression.codec"></a>spark.rapids.io.compression.codec|The CPU compression codec used to compress data at the rest for both shuffle and spill. Supported codecs: lz4, lzf, snappy, zstd|lz4|Startup
...
<a name="shuffle.io.compression.enabled"></a>spark.rapids.shuffle.io.compression.enabled|Whether to enable compression for shuffle file, it will use codec specified by spark.rapids.io.compression.codec provided by Spark|false|Startup
...
<a name="spill.io.compression.enabled"></a>spark.rapids.spill.io.compression.enabled|Whether to enable compression for spill file, it will use codec specified by spark.rapids.io.compression.codec provided by Spark|false|Startup
