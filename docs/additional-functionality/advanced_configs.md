...
<a name="sql.expression.BitwiseCount"></a>spark.rapids.sql.expression.BitwiseCount|`bit_count`|Returns the number of bits that are set in the argument|true|None|
