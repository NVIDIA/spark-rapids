...
/**
 * This is a copy of org.apache.spark.sql.execution.datasources.parquet.VectorizedColumnReader
 * which is a decoder to return values from a single column. The only difference is the
 * access-modifier for the readBatch method. We need this to expose the readBatch method to our
 * Serializer
 */
public class RapidsVectorizedColumnReader {
  /**
  ...
  public RapidsVectorizedColumnReader(
  ...
  private void readPageV2(DataPageV2 page) throws IOException {
    ...
    this.repetitionLevelColumn =
        SpecificParquetRecordReaderBase.createRLEIterator(descriptor.getMaxRepetitionLevel(),
