...
import com.nvidia.spark.rapids.{GpuColumnVector, GpuExec, GpuSemaphore, NvtxWithMetrics, RapidsHostColumnVector}
...
case class GpuColumnarToRowExec(child: SparkPlan, exportColumnarRdd: Boolean = false) 
    extends CodegenSupport with GpuExec with ColumnarToRowTransition {
