...
import com.nvidia.spark.rapids.{ExprChecks, ExprRule, GpuExpression, RuntimeReplaceableUnaryAstExprMeta, TypeSig, UnaryAstExprMeta}
...
object UnaryPositiveOverrides {
  def exprs: Map[Class[_ <: Expression], ExprRule[_ <: Expression]] = Seq(
    expr[UnaryPositive](
      ...
      (a, conf, p, r) => new RuntimeReplaceableUnaryAstExprMeta[UnaryPositive](a, conf, p, r) {
