...
import org.apache.spark.sql.execution.{CoalescedPartitionSpec, PartialMapperPartitionSpec, ShufflePartitionSpec}
...
object AQEShuffleReaderShims {
  ...
  def isCoalescedSpec(spec: ShufflePartitionSpec): Boolean = {
