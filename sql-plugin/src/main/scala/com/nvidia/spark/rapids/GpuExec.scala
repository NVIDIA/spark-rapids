...
object GpuMetric extends Logging {
  ...
  val FOOTER_FETCH_TIME = "footerFetchTime"
  val FOOTER_FILTER_TIME = "footerFilterTime"
  val FOOTER_SIZE = "footerSize"
  ...
  val DESCRIPTION_FOOTER_FETCH_TIME = "footer fetch time"
  val DESCRIPTION_FOOTER_FILTER_TIME = "footer filter time"
  val DESCRIPTION_FOOTER_SIZE = "footer size"
