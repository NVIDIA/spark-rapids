...
object SupportedOpsDocs {
  ...
  def help(): Unit = {
    ...
    println("support all data types. cuDF for Apache Spark has further")
    ...
    println("cuDF for Spark supports 128-bit starting from version 21.12 and decimals are ")
    ...
    println("cuDF for Spark only supports UTC as the time zone for timestamps.")
    println()
    ...
    println("is supported or not. Some of these are a part of cuDF for Spark and cover")
    ...
    println("|---------|----------------|")
    println("|S| (Supported) Both Apache Spark and cuDF for Spark support this type fully.|")
    println("| | (Not Applicable) Neither Spark not cuDF for Spark support this type in this situation.|")
    println("|_PS_| (Partial Support) Apache Spark supports this type, but cuDF for Spark only partially supports it. An explanation for what is missing will be included with this.|")
    println("|**NS**| (Not Supported) Apache Spark supports this type but cuDF for Spark does not.")
    println()
    ...
    println("level operations like doing a filter or project. The operations that cuDF")
    println("for Spark supports are described below.")
    println("<table>")
