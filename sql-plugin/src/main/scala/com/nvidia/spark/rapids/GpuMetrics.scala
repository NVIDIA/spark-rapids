...
object GpuMetric extends Logging {
  ...
  val OP_TIME_NEW_SHUFFLE_READ = "opTimeNewSR"
  val OP_TIME_NEW_SHUFFLE_WRITE = "opTimeNewSW"
  ...
  val DESCRIPTION_OP_TIME_NEW_SR = "operator time (shuffle read)"
  val DESCRIPTION_OP_TIME_NEW_SW = "operator time (shuffle write partition & serial)"
