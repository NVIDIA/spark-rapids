...
object GpuMetric extends Logging {
  ...
  val NUM_DISTINCT_JOINS = "numDistinctJoins"
  val NUM_HASH_JOINS = "numHashJoins"
  val NUM_SORT_MERGE_JOINS = "numSortMergeJoins"
  val JOIN_DISTINCT_TIME = "joinDistinctTime"
  val JOIN_HASH_TIME = "joinHashTime"
  val JOIN_SORT_TIME = "joinSortTime"
  val JOIN_KEY_REMAP_TIME = "joinKeyRemapTime"
  ...
  val DESCRIPTION_NUM_DISTINCT_JOINS = "distinct joins"
  val DESCRIPTION_NUM_HASH_JOINS = "hash joins"
  val DESCRIPTION_NUM_SORT_MERGE_JOINS = "sort merge joins"
  val DESCRIPTION_JOIN_DISTINCT_TIME = "distinct join time"
  val DESCRIPTION_JOIN_HASH_TIME = "hash join time"
  val DESCRIPTION_JOIN_SORT_TIME = "sort merge join time"
  val DESCRIPTION_JOIN_KEY_REMAP_TIME = "join key remapping time"
