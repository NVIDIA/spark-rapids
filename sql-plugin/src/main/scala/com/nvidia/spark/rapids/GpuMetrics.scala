...
object GpuMetric extends Logging {
  ...
  val DESCRIPTION_OP_TIME_NEW = "op time v2"
  val DESCRIPTION_OP_TIME_NEW_SHUFFLE_WRITE = "op time v2 (shuffle write partition & serial)"
  val DESCRIPTION_OP_TIME_NEW_SHUFFLE_READ = "op time v2 (shuffle read)"
