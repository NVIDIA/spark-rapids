...
case class GpuFileSourceScanExec(
  ...
  override lazy val allMetrics = Map(
    ...
    // Debug metrics for scan time breakdown - top level
    DEBUG_INIT_READERS_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_INIT_READERS_TIME),
    DEBUG_BATCH_ITER_NEXT_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_BATCH_ITER_NEXT_TIME),
    DEBUG_INIT_FILTER_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_INIT_FILTER_TIME),
    DEBUG_WAIT_BG_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_WAIT_BG_TIME),
    BG_ALLOC_TIME -> createNanoTimingMetric(MODERATE_LEVEL, DESCRIPTION_BG_ALLOC_TIME),
    ...
    // Sub-metrics of DEBUG_READ_BUFFER_TO_BATCHES_TIME (RBTB)
    DEBUG_RBTB_GET_PARQUET_OPTIONS_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_RBTB_GET_PARQUET_OPTIONS_TIME),
    DEBUG_RBTB_MATERIALIZE_HOST_BUFFER_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_RBTB_MATERIALIZE_HOST_BUFFER_TIME),
    DEBUG_RBTB_MAKE_PRODUCER_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_RBTB_MAKE_PRODUCER_TIME),
    DEBUG_RBTB_CACHED_ITER_APPLY_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_RBTB_CACHED_ITER_APPLY_TIME),
    DEBUG_RBTB_TABLE_TO_BATCH_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_RBTB_TABLE_TO_BATCH_TIME),
    DEBUG_RBTB_EVOLVE_SCHEMA_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_RBTB_EVOLVE_SCHEMA_TIME),
    DEBUG_RBTB_REBASE_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_RBTB_REBASE_TIME),
    DEBUG_RBTB_ADD_PARTITION_VALUES_TIME -> createNanoTimingMetric(DEBUG_LEVEL,
      DESCRIPTION_DEBUG_RBTB_ADD_PARTITION_VALUES_TIME)
  ) ++ fileCacheMetrics ++ {
