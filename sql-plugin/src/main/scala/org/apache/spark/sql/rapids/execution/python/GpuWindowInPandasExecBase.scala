...
import org.apache.spark.sql.rapids.execution.python.shims.{GpuWindowPythonRunnerFactory, PythonArgumentUtils}
...
trait GpuWindowInPandasExecBase extends ShimUnaryExecNode with GpuPythonExecBase {
  ...
  protected val windowBoundTypeConf = 
    org.apache.spark.sql.rapids.execution.python.shims.WindowBoundTypeConfShims.windowBoundTypeConf
