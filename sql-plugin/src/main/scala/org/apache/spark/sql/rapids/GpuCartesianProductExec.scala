...
import com.nvidia.spark.rapids.{Arm, GpuBinaryExecNode, GpuBindReferences, GpuBuildLeft, GpuColumnVector, GpuExec, GpuExpression, GpuMetric, GpuSemaphore, MetricsLevel, RapidsBuffer, SpillableColumnarBatch, SpillPriorities}
...
case class GpuCartesianProductExec(
    ...
    targetSizeBytes: Long) extends GpuBinaryExecNode with GpuExec {
