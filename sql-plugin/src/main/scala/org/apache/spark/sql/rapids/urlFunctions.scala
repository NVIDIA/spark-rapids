...
object GpuParseUrl {
  ...
  //                            """^(?:(?:(  [^:/?#]+):)?(?://(  (?:(?:(?:[^\@/]*)@)?(\[[\w%.:]+\]|[^/#:?]*))(?::[0-9]+)?))?(([^?#]*)(\?[^#]*)?)(#.*)?)$"""
  private val HOST_REGEX      = """^(?:(?:(?:[\w+\-.]+):)?(?:[0-9]+[^\\#]*|(?://(?:(?:(?:(?:[\w%\-_.!~*'();:&=+$,]*)@)?(\[[\w%.:]+\]|[^/\\#:?"<>\^`{|}]*))(?::[0-9]+)?))?(?:[^?#[\]\\"<>\^`{|}]*)?(?:\?[^\\"#<>\^`{|}]*)?)(?:#[\w\-_.!~*'();/?:@&=+$,[\]%]*)?)$"""
  private val PATH_REGEX      = """^(?:[\w+\-.]+:[^/#][^/#][^#]*|(?:[\w+\-.]+:)?(?://(?:[\w%\-_.!~*'();:&=+$,]*@)?(?:\[[\w%.:]+\]|[^/\\#:?"<>\^`{|}]*)(?::[0-9]+)?)?([^?#[\]\\"<>\^`{|}]*)?(?:\?[^\\"#<>\^`{|}]*)?)(?:#[\w\-_.!~*'();/?:@&=+$,[\]%]*)?$"""
  private val QUERY_REGEX     = """^(?:(?:(?:[\w+\-.]+):)?(?:[0-9]+[^\\#]*|(?://(?:(?:(?:(?:[\w%\-_.!~*'();:&=+$,]*)@)?(?:\[[\w%.:]+\]|[^/\\#:?"<>\^`{|}]*))(?::[0-9]+)?))?(?:[^?#[\]\\"<>\^`{|}]*)?(\?[^\\"#<>\^`{|}]*)?)(?:#[\w\-_.!~*'();/?:@&=+$,[\]%]*)?)$"""
  private val REF_REGEX       = """^(?:(?:(?:[\w+\-.]+):)?(?:[0-9]+[^\\#]*|(?://(?:(?:(?:(?:[\w%\-_.!~*'();:&=+$,]*)@)?(?:\[[\w%.:]+\]|[^/\\#:?"<>\^`{|}]*))(?::[0-9]+)?))?(?:[^?#[\]\\"<>\^`{|}]*)?(?:\?[^\\"#<>\^`{|}]*)?)(#[\w\-_.!~*'();/?:@&=+$,[\]%]*)?)$"""
  private val PROTOCOL_REGEX  = """^(?:(?:([\w+\-.]+):)?(?:(?:[0-9]+[^\\#]*|(?://(?:(?:(?:[\w%\-_.!~*'();:&=+$,]*)@)?(?:\[[\w%.:]+\]|[^/\\#:?"<>\^`{|}]*))(?::[0-9]+)?))?(?:[^?#[\]\\"<>\^`{|}]*)?(?:\?[^\\"#<>\^`{|}]*)?)(?:#[\w\-_.!~*'();/?:@&=+$,[\]%]*)?)$"""
  private val FILE_REGEX      = """^(?:[\w+\-.]+:[^/#][^/#][^#]*|(?:[\w+\-.]+:)?(?://(?:[\w%\-_.!~*'();:&=+$,]*@)?(?:\[[\w%.:]+\]|[^/\\#:?"<>\^`{|}]*)(?::[0-9]+)?)?((?:[^?#[\]\\"<>\^`{|}]*)?(?:\?[^\\"#<>\^`{|}]*)?))(?:#[\w\-_.!~*'();/?:@&=+$,[\]%]*)?$"""
  private val AUTHORITY_REGEX = """^(?:(?:(?:[\w+\-.]+):)?(?:[0-9]+[^\\#]*|(?://((?:(?:(?:[\w%\-_.!~*'();:&=+$,]*)@)?(?:\[[\w%.:]+\]|[^/\\#:?"<>\^`{|}]*))(?::[0-9]+)?))?(?:[^?#[\]\\"<>\^`{|}]*)?(?:\?[^\\"#<>\^`{|}]*)?)(?:#[\w\-_.!~*'();/?:@&=+$,[\]%]*)?)$"""
  private val USERINFO_REGEX  = """^(?:(?:(?:[\w+\-.]+):)?(?:[0-9]+[^\\#]*|(?://(?:(?:(?:([\w%\-_.!~*'();:&=+$,]*)@)?(?:\[[\w%.:]+\]|[^/\\#:?"<>\^`{|}]*))(?::[0-9]+)?))?(?:[^?#[\]\\"<>\^`{|}]*)?(?:\?[^\\"#<>\^`{|}]*)?)(?:#[\w\-_.!~*'();/?:@&=+$,[\]%]*)?)$"""
  // HostName parsing followed rules in java URI lib:
  // hostname      = domainlabel [ "." ] | 1*( domainlabel "." ) toplabel [ "." ]
  // domainlabel   = alphanum | alphanum *( alphanum | "-" ) alphanum
  // toplabel      = alpha | alpha *( alphanum | "-" ) alphanum
  val hostnameRegex = """((([0-9a-zA-Z]|[0-9a-zA-Z][0-9a-zA-Z\-]*[0-9a-zA-Z])|(([0-9a-zA-Z]|[0-9a-zA-Z][0-9a-zA-Z\-]*[0-9a-zA-Z])\.)+([a-zA-Z]|[a-zA-Z][0-9a-zA-Z\-]*[0-9a-zA-Z]))\.?)"""
