...
//        if (!cudfDecimal.equals(rhs.getBase.getType)) {
//          withResource(rhs.getBase.round(sparkDecimal.scale)) { rounded =>
//            GpuColumnVector.from(rounded.castTo(cudfDecimal), sparkDecimal)
//          }
//        } else {
//          rhs.incRefCount()
//        }
...
//      }
//    } { newRhs =>
//      doColumnar(lhs.getBase, newRhs.getBase)
//    }
//  }
//
...
//        val sparkDecimal = dataType.asInstanceOf[DecimalType]
//        val cudfDecimal = DecimalUtil.createCudfDecimal(sparkDecimal)
//        if (!cudfDecimal.equals(lhs.getBase.getType)) {
//          withResource(lhs.getBase.round(sparkDecimal.scale)) { rounded =>
//            GpuColumnVector.from(rounded.castTo(cudfDecimal), sparkDecimal)
//          }
//        } else {
//          lhs.incRefCount()
...
//      }
//    } { newLhs =>
//      doColumnar(newLhs.getBase, rhs.getBase)
//    }
//  }
//
...
//        }
//      } { newRhs =>
//        doColumnar(newLhs.getBase, newRhs.getBase)
//      }
//    }
//  }
