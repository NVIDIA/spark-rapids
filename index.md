...
nav_order: 1
permalink: /
description: This site serves as a collection of documentation about Apache Spark Accelerated With cuDF (previously RAPIDS Accelerator for Apache Spark)
---
# Overview
**If you are a customer looking for information on how to adopt Apache Spark Accelerated With cuDF (previously RAPIDS Accelerator for Apache Spark)
...
The Apache Spark Accelerated With cuDF (previously RAPIDS Accelerator for Apache Spark) leverages GPUs to accelerate processing via the
...
The Apache Spark Accelerated With cuDF (previously RAPIDS Accelerator for Apache Spark) combines the power of the [RAPIDS cuDF](https://github.com/rapidsai/cudf/) library and
