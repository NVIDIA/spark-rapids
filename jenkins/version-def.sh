...
CUDF_VER=${CUDF_VER:-"23.06.0-SNAPSHOT"} # TODO: https://github.com/NVIDIA/spark-rapids/issues/8358
CUDA_CLASSIFIER=${CUDA_CLASSIFIER:-"cuda11"}
PROJECT_VER=${PROJECT_VER:-"23.08.0-SNAPSHOT"}
PROJECT_TEST_VER=${PROJECT_TEST_VER:-"23.08.0-SNAPSHOT"}
