...
CUDF_VER=${CUDF_VER:-"24.02.0-SNAPSHOT"} # TODO: https://github.com/NVIDIA/spark-rapids/issues/10256
CUDA_CLASSIFIER=${CUDA_CLASSIFIER:-"cuda11"}
CLASSIFIER=${CLASSIFIER:-"$CUDA_CLASSIFIER"} # default as CUDA_CLASSIFIER for compatibility
PROJECT_VER=${PROJECT_VER:-"24.04.0-SNAPSHOT"}
PROJECT_TEST_VER=${PROJECT_TEST_VER:-"24.04.0-SNAPSHOT"}
