...
mvn_verify() {
    ...
    env -u SPARK_HOME mvn -U -B $MVN_URM_MIRROR -Dbuildver=301 clean install -Drat.skip=true -DskipTests -Dmaven.javadoc.skip=true -Dskip -Dmaven.scalastyle.skip=true -Dcuda.version=$CUDA_CLASSIFIER -pl aggregator -am
