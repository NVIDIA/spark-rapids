...
ci_2() {
    ...
    TEST_PARALLEL=5 TEST='if_else or case_when' ./integration_tests/run_pyspark_from_build.sh
    # TEST_PARALLEL=5 TEST='conditionals_test or window_function_test' ./integration_tests/run_pyspark_from_build.sh
