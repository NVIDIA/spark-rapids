...
BASE_SPARK_VERSION=3.1.1
BUILD_PROFILES=databricks310
...
SPARK_VERSION_TO_INSTALL_DATABRICKS_JARS=3.1.0-databricks
...
SQLJAR=----workspace_spark_3_1--sql--core--core-hive-2.3__hadoop-2.7_${SCALA_VERSION}_deploy.jar
