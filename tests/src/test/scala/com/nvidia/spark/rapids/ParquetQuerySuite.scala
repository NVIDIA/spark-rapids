...
class ParquetQuerySuite extends SparkQueryCompareTestSuite {
  ...
  /**
   * udt.parquet is generated by CPU, the schema and the data are from `getSchema` and `getData`.
   */
  testGpuFallback("Reading UDT in ColumnVector, falls back when specify schema",
    "FileSourceScanExec",
    spark => {
