...
class RapidsTestSettings extends BackendTestSettings {
  ...
  enableSuite[RapidsSQLQuerySuite]
    ...
    .exclude("SPARK-3349 partitioning after limit", ADJUST_UT("Replaced by testRapids version that uses order-insensitive comparison since GPU hash joins don't guarantee output order"))
