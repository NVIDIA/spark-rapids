...
```
$SPARK_HOME/bin/spark-submit --jars "rapids-4-spark_2.12-21.12.0-SNAPSHOT.jar,rapids-4-spark-udf-examples_2.12-21.12.0-SNAPSHOT.jar,cudf-21.12.0-cuda11.jar" ./runtests.py
```
