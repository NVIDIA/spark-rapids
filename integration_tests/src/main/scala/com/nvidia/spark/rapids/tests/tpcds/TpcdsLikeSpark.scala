  ...
  private val tables = Array(
    Table(
      ...
      StructType(Array(
        ...
        StructField("cs_wholesale_cost", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_list_price", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_sales_price", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_ext_discount_amt", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_ext_sales_price", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_ext_wholesale_cost", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_ext_list_price", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_ext_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_coupon_amt", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_ext_ship_cost", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_net_paid", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_net_paid_inc_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_net_paid_inc_ship", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_net_paid_inc_ship_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("cs_net_profit", DoubleType) // should be DecimalType(7, 2)
      ))),
    Table(
      "catalog_returns",
      ...
      StructType(Array(
        ...
        StructField("cr_return_amount", DoubleType), // should be DecimalType(7, 2)
        StructField("cr_return_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("cr_return_amt_inc_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("cr_fee", DoubleType), // should be DecimalType(7, 2)
        StructField("cr_return_ship_cost", DoubleType), // should be DecimalType(7, 2)
        StructField("cr_refunded_cash", DoubleType), // should be DecimalType(7, 2)
        StructField("cr_reversed_charge", DoubleType), // should be DecimalType(7, 2)
        StructField("cr_store_credit", DoubleType), // should be DecimalType(7, 2)
        StructField("cr_net_loss", DoubleType) // should be DecimalType(7, 2)
      ))),
    Table(
      "inventory",
      Seq("inv_date_sk"),
    ...
    Table(
      ...
      StructType(Array(
        ...
        StructField("ss_wholesale_cost", DoubleType), // should be DecimalType(7, 2)
        StructField("ss_list_price", DoubleType), // should be DecimalType(7, 2)
        StructField("ss_sales_price", DoubleType), // should be DecimalType(7, 2)
        StructField("ss_ext_discount_amt", DoubleType), // should be DecimalType(7, 2)
        StructField("ss_ext_sales_price", DoubleType), // should be DecimalType(7, 2)
        StructField("ss_ext_wholesale_cost", DoubleType), // should be DecimalType(7, 2)
        StructField("ss_ext_list_price", DoubleType), // should be DecimalType(7, 2)
        StructField("ss_ext_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("ss_coupon_amt", DoubleType), // should be DecimalType(7, 2)
        StructField("ss_net_paid", DoubleType), // should be DecimalType(7, 2)
        StructField("ss_net_paid_inc_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("ss_net_profit", DoubleType) // should be DecimalType(7, 2)
      ))),
    Table(
      "store_returns",
      ...
      StructType(Array(
        ...
        StructField("sr_return_amt", DoubleType), // should be DecimalType(7, 2)
        StructField("sr_return_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("sr_return_amt_inc_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("sr_fee", DoubleType), // should be DecimalType(7, 2)
        StructField("sr_return_ship_cost", DoubleType), // should be DecimalType(7, 2)
        StructField("sr_refunded_cash", DoubleType), // should be DecimalType(7, 2)
        StructField("sr_reversed_charge", DoubleType), // should be DecimalType(7, 2)
        StructField("sr_store_credit", DoubleType), // should be DecimalType(7, 2)
        StructField("sr_net_loss", DoubleType) // should be DecimalType(7, 2)
      ))),
    Table(
      "web_sales",
      Seq("ws_sold_date_sk"),
      StructType(Array(
        ...
        StructField("ws_wholesale_cost", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_list_price", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_sales_price", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_ext_discount_amt", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_ext_sales_price", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_ext_wholesale_cost", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_ext_list_price", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_ext_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_coupon_amt", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_ext_ship_cost", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_net_paid", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_net_paid_inc_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_net_paid_inc_ship", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_net_paid_inc_ship_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("ws_net_profit", DoubleType) // should be DecimalType(7, 2)
      ))),
    Table(
      "web_returns",
      ...
      StructType(Array(
        ...
        StructField("wr_return_amt", DoubleType), // should be DecimalType(7, 2)
        StructField("wr_return_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("wr_return_amt_inc_tax", DoubleType), // should be DecimalType(7, 2)
        StructField("wr_fee", DoubleType), // should be DecimalType(7, 2)
        StructField("wr_return_ship_cost", DoubleType), // should be DecimalType(7, 2)
        StructField("wr_refunded_cash", DoubleType), // should be DecimalType(7, 2)
        StructField("wr_reversed_charge", DoubleType), // should be DecimalType(7, 2)
        StructField("wr_account_credit", DoubleType), // should be DecimalType(7, 2)
        StructField("wr_net_loss", DoubleType) // should be DecimalType(7, 2)
      ))),
    Table(
      "call_center",
      Seq(),
      StructType(Array(
        ...
        StructField("cc_gmt_offset", DoubleType), // should be DecimalType(5, 2)
        StructField("cc_tax_percentage", DoubleType) // should be DecimalType(5, 2)
      ))),
    Table(
      "catalog_page",
      Seq(),
    ...
    Table(
      ...
      StructType(Array(
        ...
        StructField("ca_gmt_offset", DoubleType), // should be DecimalType(5, 2)
    ...
    Table(
      ...
      StructType(Array(
        ...
        StructField("i_current_price", DoubleType), // should be DecimalType(7, 2)
        StructField("i_wholesale_cost", DoubleType), // should be DecimalType(7, 2)
    ...
    Table(
      ...
      StructType(Array(
        ...
        StructField("p_cost", DoubleType), // should be DecimalType(15, 2)
    ...
    Table(
      ...
      StructType(Array(
        ...
        StructField("s_gmt_offset", DoubleType), // should be DecimalType(5, 2)
        StructField("s_tax_precentage", DoubleType) // should be DecimalType(5, 2)
      ))),
    Table(
      "time_dim",
      Seq(),
    ...
    Table(
      ...
      StructType(Array(
        ...
        StructField("w_gmt_offset", DoubleType) // should be DecimalType(5, 2)
      ))),
    Table(
      "web_page",
      Seq(),
  ...
  val queries : Map[String, Query] = Array(
    ...
    Query("q14b",
      """
        ...
        |        this_year.i_brand_id as ty_i_brand_id,
        |        last_year.i_brand_id as ly_i_branch_id,
        |        this_year.i_category_id as ty_i_category_id,
        |        last_year.i_category_id as ly_i_category_id,
        |        this_year.i_class_id as ty_i_class_id,
        |        last_year.i_class_id as ly_i_class_id,
        |        this_year.number_sales as ty_number_sales,
        |        last_year.number_sales as ly_number_sales,
        |        this_year.sales as ty_sales,
        |        last_year.sales as ly_sales from
        ...
        | order by ty_channel, ty_i_brand_id, ty_i_class_id, ty_i_category_id
        | limit 100
        |""".stripMargin),
    Query("q15",
      """
    ...
    Query("q64",
      """
        ...
        | order by cs1.product_name, cs1.store_name, cs2_cnt
        |""".stripMargin),
    Query("q65",
      """
        | select
