...
import org.apache.spark.sql.types.{DataType, DateType, DecimalType, DoubleType, IntegerType, LongType, StringType, StructField, StructType}
...
object TpcdsLikeSpark {
  ...
  private def decimalType(useDecimalType: Boolean, p: Int, s: Int): DataType = {
    if (useDecimalType) {
      DecimalType(p, s)
    } else {
      DoubleType
  ...
  private def tables(useDecimalType: Boolean) = {
    Array(
      Table(
        "catalog_sales",
        Seq("cs_sold_date_sk"),
        StructType(Array(
          ...
          StructField("cs_wholesale_cost", decimalType(useDecimalType, 7, 2)),
          StructField("cs_list_price", decimalType(useDecimalType, 7, 2)),
          StructField("cs_sales_price", decimalType(useDecimalType, 7, 2)),
          StructField("cs_ext_discount_amt", decimalType(useDecimalType, 7, 2)),
          StructField("cs_ext_sales_price", decimalType(useDecimalType, 7, 2)),
          StructField("cs_ext_wholesale_cost", decimalType(useDecimalType, 7, 2)),
          StructField("cs_ext_list_price", decimalType(useDecimalType, 7, 2)),
          StructField("cs_ext_tax", decimalType(useDecimalType, 7, 2)),
          StructField("cs_coupon_amt", decimalType(useDecimalType, 7, 2)),
          StructField("cs_ext_ship_cost", decimalType(useDecimalType, 7, 2)),
          StructField("cs_net_paid", decimalType(useDecimalType, 7, 2)),
          StructField("cs_net_paid_inc_tax", decimalType(useDecimalType, 7, 2)),
          StructField("cs_net_paid_inc_ship", decimalType(useDecimalType, 7, 2)),
          StructField("cs_net_paid_inc_ship_tax", decimalType(useDecimalType, 7, 2)),
          StructField("cs_net_profit", decimalType(useDecimalType, 7, 2))
        ))),
      Table(
        "catalog_returns",
        ...
        StructType(Array(
          ...
          StructField("cr_return_amount", decimalType(useDecimalType, 7, 2)),
          StructField("cr_return_tax", decimalType(useDecimalType, 7, 2)),
          StructField("cr_return_amt_inc_tax", decimalType(useDecimalType, 7, 2)),
          StructField("cr_fee", decimalType(useDecimalType, 7, 2)),
          StructField("cr_return_ship_cost", decimalType(useDecimalType, 7, 2)),
          StructField("cr_refunded_cash", decimalType(useDecimalType, 7, 2)),
          StructField("cr_reversed_charge", decimalType(useDecimalType, 7, 2)),
          StructField("cr_store_credit", decimalType(useDecimalType, 7, 2)),
          StructField("cr_net_loss", decimalType(useDecimalType, 7, 2))
        ))),
      Table(
        "inventory",
        Seq("inv_date_sk"),
      ...
      Table(
        ...
        StructType(Array(
          ...
          StructField("ss_wholesale_cost", decimalType(useDecimalType, 7, 2)),
          StructField("ss_list_price", decimalType(useDecimalType, 7, 2)),
          StructField("ss_sales_price", decimalType(useDecimalType, 7, 2)),
          StructField("ss_ext_discount_amt", decimalType(useDecimalType, 7, 2)),
          StructField("ss_ext_sales_price", decimalType(useDecimalType, 7, 2)),
          StructField("ss_ext_wholesale_cost", decimalType(useDecimalType, 7, 2)),
          StructField("ss_ext_list_price", decimalType(useDecimalType, 7, 2)),
          StructField("ss_ext_tax", decimalType(useDecimalType, 7, 2)),
          StructField("ss_coupon_amt", decimalType(useDecimalType, 7, 2)),
          StructField("ss_net_paid", decimalType(useDecimalType, 7, 2)),
          StructField("ss_net_paid_inc_tax", decimalType(useDecimalType, 7, 2)),
          StructField("ss_net_profit", decimalType(useDecimalType, 7, 2))
        ))),
      Table(
        "store_returns",
        ...
        StructType(Array(
          ...
          StructField("sr_return_amt", decimalType(useDecimalType, 7, 2)),
          StructField("sr_return_tax", decimalType(useDecimalType, 7, 2)),
          StructField("sr_return_amt_inc_tax", decimalType(useDecimalType, 7, 2)),
          StructField("sr_fee", decimalType(useDecimalType, 7, 2)),
          StructField("sr_return_ship_cost", decimalType(useDecimalType, 7, 2)),
          StructField("sr_refunded_cash", decimalType(useDecimalType, 7, 2)),
          StructField("sr_reversed_charge", decimalType(useDecimalType, 7, 2)),
          StructField("sr_store_credit", decimalType(useDecimalType, 7, 2)),
          StructField("sr_net_loss", decimalType(useDecimalType, 7, 2))
        ))),
      Table(
        "web_sales",
        Seq("ws_sold_date_sk"),
        StructType(Array(
          ...
          StructField("ws_wholesale_cost", decimalType(useDecimalType, 7, 2)),
          StructField("ws_list_price", decimalType(useDecimalType, 7, 2)),
          StructField("ws_sales_price", decimalType(useDecimalType, 7, 2)),
          StructField("ws_ext_discount_amt", decimalType(useDecimalType, 7, 2)),
          StructField("ws_ext_sales_price", decimalType(useDecimalType, 7, 2)),
          StructField("ws_ext_wholesale_cost", decimalType(useDecimalType, 7, 2)),
          StructField("ws_ext_list_price", decimalType(useDecimalType, 7, 2)),
          StructField("ws_ext_tax", decimalType(useDecimalType, 7, 2)),
          StructField("ws_coupon_amt", decimalType(useDecimalType, 7, 2)),
          StructField("ws_ext_ship_cost", decimalType(useDecimalType, 7, 2)),
          StructField("ws_net_paid", decimalType(useDecimalType, 7, 2)),
          StructField("ws_net_paid_inc_tax", decimalType(useDecimalType, 7, 2)),
          StructField("ws_net_paid_inc_ship", decimalType(useDecimalType, 7, 2)),
          StructField("ws_net_paid_inc_ship_tax", decimalType(useDecimalType, 7, 2)),
          StructField("ws_net_profit", decimalType(useDecimalType, 7, 2))
        ))),
      Table(
        "web_returns",
        ...
        StructType(Array(
          ...
          StructField("wr_return_amt", decimalType(useDecimalType, 7, 2)),
          StructField("wr_return_tax", decimalType(useDecimalType, 7, 2)),
          StructField("wr_return_amt_inc_tax", decimalType(useDecimalType, 7, 2)),
          StructField("wr_fee", decimalType(useDecimalType, 7, 2)),
          StructField("wr_return_ship_cost", decimalType(useDecimalType, 7, 2)),
          StructField("wr_refunded_cash", decimalType(useDecimalType, 7, 2)),
          StructField("wr_reversed_charge", decimalType(useDecimalType, 7, 2)),
          StructField("wr_account_credit", decimalType(useDecimalType, 7, 2)),
          StructField("wr_net_loss", decimalType(useDecimalType, 7, 2))
        ))),
      Table(
        "call_center",
        Seq(),
        StructType(Array(
          ...
          StructField("cc_gmt_offset", decimalType(useDecimalType, 5, 2)),
          StructField("cc_tax_percentage", decimalType(useDecimalType, 5, 2))
        ))),
      Table(
        "catalog_page",
        Seq(),
      ...
      Table(
        ...
        StructType(Array(
          ...
          StructField("ca_gmt_offset", decimalType(useDecimalType, 5, 2)),
      ...
      Table(
        ...
        StructType(Array(
          ...
          StructField("i_current_price", decimalType(useDecimalType, 7, 2)),
          StructField("i_wholesale_cost", decimalType(useDecimalType, 7, 2)),
      ...
      Table(
        ...
        StructType(Array(
          ...
          StructField("p_cost", DoubleType), // should be decimalType(useDecimalType, 15, 2)
      ...
      Table(
        ...
        StructType(Array(
          ...
          StructField("s_gmt_offset", decimalType(useDecimalType, 5, 2)),
          StructField("s_tax_precentage", decimalType(useDecimalType, 5, 2))
        ))),
      Table(
        "time_dim",
        Seq(),
      ...
      Table(
        ...
        StructType(Array(
          ...
          StructField("w_gmt_offset", decimalType(useDecimalType, 5, 2))
        ))),
      Table(
        "web_page",
        Seq(),
      ...
      Table(
        ...
        StructType(Array(
          ...
          StructField("web_gmt_offset", decimalType(useDecimalType, 5, 2)),
          StructField("web_tax_percentage", decimalType(useDecimalType, 5, 2))
        )))
    )
  }
