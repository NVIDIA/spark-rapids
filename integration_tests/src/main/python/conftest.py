...
class TpchRunner:
  ...
  def setup(self, spark):
    ...
    jvm = _get_jvm(spark)
    formats = {
      "csv": jvm.com.nvidia.sparkexamples.tpch.TpchLikeSpark.setupAllCSV,
      "parquet": jvm.com.nvidia.sparkexamples.tpch.TpchLikeSpark.setupAllParquet,
      "orc": jvm.com.nvidia.sparkexamples.tpch.TpchLikeSpark.setupAllOrc
    }
  ...
  def do_test_query(self, query):
    ...
    jvm = _get_jvm(spark)
    tests = {
      "q1": jvm.com.nvidia.sparkexamples.tpch.Q1Like,
      "q2": jvm.com.nvidia.sparkexamples.tpch.Q2Like,
      "q3": jvm.com.nvidia.sparkexamples.tpch.Q3Like,
      "q4": jvm.com.nvidia.sparkexamples.tpch.Q4Like,
      "q5": jvm.com.nvidia.sparkexamples.tpch.Q5Like,
      "q6": jvm.com.nvidia.sparkexamples.tpch.Q6Like,
      "q7": jvm.com.nvidia.sparkexamples.tpch.Q7Like,
      "q8": jvm.com.nvidia.sparkexamples.tpch.Q8Like,
      "q9": jvm.com.nvidia.sparkexamples.tpch.Q9Like,
      "q10": jvm.com.nvidia.sparkexamples.tpch.Q10Like,
      "q11": jvm.com.nvidia.sparkexamples.tpch.Q11Like,
      "q12": jvm.com.nvidia.sparkexamples.tpch.Q12Like,
      "q13": jvm.com.nvidia.sparkexamples.tpch.Q13Like,
      "q14": jvm.com.nvidia.sparkexamples.tpch.Q14Like,
      "q15": jvm.com.nvidia.sparkexamples.tpch.Q15Like,
      "q16": jvm.com.nvidia.sparkexamples.tpch.Q16Like,
      "q17": jvm.com.nvidia.sparkexamples.tpch.Q17Like,
      "q18": jvm.com.nvidia.sparkexamples.tpch.Q18Like,
      "q19": jvm.com.nvidia.sparkexamples.tpch.Q19Like,
      "q20": jvm.com.nvidia.sparkexamples.tpch.Q20Like,
      "q21": jvm.com.nvidia.sparkexamples.tpch.Q21Like,
      "q22": jvm.com.nvidia.sparkexamples.tpch.Q22Like
    }
...
class TpcxbbRunner:
  ...
  def setup(self, spark):
    ...
    jvm = _get_jvm(spark)
    formats = {
      "csv": jvm.com.nvidia.sparkexamples.tpcxbb.TpcxbbLikeSpark.setupAllCSV,
      "parquet": jvm.com.nvidia.sparkexamples.tpcxbb.TpcxbbLikeSpark.setupAllParquet,
      "orc": jvm.com.nvidia.sparkexamples.tpcxbb.TpcxbbLikeSpark.setupAllOrc
    }
  ...
  def do_test_query(self, query):
    ...
    jvm = _get_jvm(spark)
    tests = {
      "q5": jvm.com.nvidia.sparkexamples.tpcxbb.Q5Like,
      "q16": jvm.com.nvidia.sparkexamples.tpcxbb.Q16Like,
      "q21": jvm.com.nvidia.sparkexamples.tpcxbb.Q21Like,
      "q22": jvm.com.nvidia.sparkexamples.tpcxbb.Q22Like
    }
    df = tests.get(query).apply(jvm_session)
    return DataFrame(df, spark.getActiveSession())
...
class MortgageRunner:
  ...
  def do_test_query(self, spark):
    ...
    run = jvm.com.nvidia.sparkexamples.mortgage.Run
