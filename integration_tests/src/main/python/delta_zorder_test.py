...
from delta_lake_utils import deletion_vector_values_with_xfailing_scans_for_350DB143
...
@pytest.mark.parametrize("enable_deletion_vectors", deletion_vector_values_with_xfailing_scans_for_350DB143, ids=idfn)
