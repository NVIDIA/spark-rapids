...
@incompat
@allow_any_non_gpu #really just take ordered and project
...
@incompat #fp compare
@allow_any_non_gpu #really just scalar subquery
...
@allow_any_non_gpu # nested loop join
...
@allow_any_non_gpu # join conditions, take ordered and project
def test_tpch_q21(tpch):
  assert_gpu_and_cpu_are_equal_collect(
          lambda spark : tpch.do_test_query("q21"), conf=_base_conf)

@incompat #fp compare
@allow_any_non_gpu # ScalarSubString
