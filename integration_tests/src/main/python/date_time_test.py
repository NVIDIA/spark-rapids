...
@allow_non_gpu('ProjectExec', 'FromUTCTimestamp', 'BoundReference')
...
@allow_non_gpu('ProjectExec','ToUTCTimestamp', 'BoundReference')
...
@allow_non_gpu('ProjectExec', 'FromUnixTime', 'BoundReference')
...
@allow_non_gpu('ProjectExec', 'DateFormatClass', 'Cast', 'BoundReference', 'Literal')
...
@allow_non_gpu('ProjectExec', 'DateFormatClass', 'Cast', 'BoundReference')
@pytest.mark.parametrize('data_gen', date_n_time_gens, ids=idfn)
...
@allow_non_gpu('ProjectExec', 'GetTimestamp', 'BoundReference')
