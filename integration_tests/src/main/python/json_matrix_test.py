...
@allow_non_gpu(TEXT_INPUT_EXEC, 'ProjectExec', 'JsonToStructs', 'BoundReference')
...
@allow_non_gpu('ProjectExec', 'JsonToStructs', 'BoundReference', TEXT_INPUT_EXEC)
...
@allow_non_gpu(TEXT_INPUT_EXEC, 'ProjectExec', 'JsonToStructs', 'BoundReference', *non_utc_allow) # https://github.com/NVIDIA/spark-rapids/issues/10453
@pytest.mark.parametrize('locale', NON_US_DEC_LOCALES)
