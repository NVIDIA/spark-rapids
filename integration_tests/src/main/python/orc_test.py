...
unsupported_tz_allow_fallback_ops = ['ColumnarToRowExec', 'FileSourceScanExec', 'BatchScanExec'] \
...
@allow_non_gpu(*unsupported_tz_allow_fallback_ops)
...
unsupported_tz_allow_fallback_ops_for_read_and_write = unsupported_tz_allow_fallback_ops + ["DataWritingCommandExec", "WriteFilesExec"] \
    if is_not_utc() and (not is_Shanghai_timezone()) else []
...
@allow_non_gpu(*unsupported_tz_allow_fallback_ops_for_read_and_write)
@tz_sensitive_test
