...
from spark_session import is_before_spark_314, is_before_spark_322, is_spark_320_or_later, with_cpu_session, with_gpu_session, with_spark_session, is_before_spark_320, is_before_spark_330, is_databricks91_or_later, is_databricks104_or_later
...
@pytest.mark.skipif(
    not (is_before_spark_314() or (is_spark_320_or_later() and is_before_spark_322())),
    reason="Only Spark [311, 314) and [320, 322) will throw the exception")
def test_cast_neg_to_decimal_err():
    ...
    exception_str = "java.lang.ArithmeticException: " + exception_content if not is_databricks104_or_later() else \
