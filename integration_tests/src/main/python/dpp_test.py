...
dpp_like_any_fallback_execs=['FilterExec', 'CollectLimitExec', 'LikeAny', 'BoundReference'] if is_databricks_version_or_later(14,3) else ['FilterExec', 'LikeAny', 'BoundReference']
