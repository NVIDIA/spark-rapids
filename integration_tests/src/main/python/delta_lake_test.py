...
from spark_session import with_cpu_session, with_gpu_session, is_databricks104_or_later, spark_version

_conf = {'spark.rapids.sql.explain': 'ALL'}

@delta_lake
@allow_non_gpu('FileSourceScanExec')
@pytest.mark.skipif(not (is_databricks104_or_later() or spark_version().startswith("3.2.")), \
