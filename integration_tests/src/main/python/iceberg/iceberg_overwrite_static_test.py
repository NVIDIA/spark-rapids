...
def test_insert_overwrite_unpartitioned_table(spark_tmp_table_factory, format_version):
...
@ignore_order(local=True)
@pytest.mark.parametrize("format_version", ["1", "2"], ids=lambda x: f"format_version={x}")
def test_insert_overwrite_unpartitioned_table_values(spark_tmp_table_factory, format_version):
...
def test_insert_overwrite_partitioned_table(spark_tmp_table_factory, format_version, partition_col_sql):
...
@pytest.mark.parametrize("format_version", ["1", "2"], ids=lambda x: f"format_version={x}")
def test_insert_overwrite_specific_partition_identity_fallback(spark_tmp_table_factory, format_version):
...
@allow_non_gpu('OverwriteByExpressionExec', 'ShuffleExchangeExec', 'SortExec', 'ProjectExec')
@pytest.mark.parametrize("format_version", ["1", "2"], ids=lambda x: f"format_version={x}")
def test_insert_overwrite_unpartitioned_table_all_cols_fallback(spark_tmp_table_factory, format_version):
...
@allow_non_gpu('OverwriteByExpressionExec', 'ShuffleExchangeExec', 'SortExec', 'ProjectExec')
@pytest.mark.parametrize("format_version", ["1", "2"], ids=lambda x: f"format_version={x}")
def test_insert_overwrite_partitioned_table_all_cols_fallback(spark_tmp_table_factory, format_version):
...
def test_insert_overwrite_partitioned_table_unsupported_partition_fallback(
        spark_tmp_table_factory, format_version, partition_col_sql):
...
def test_insert_overwrite_table_unsupported_file_format_fallback(
        spark_tmp_table_factory, format_version, file_format):
...
def test_insert_overwrite_iceberg_table_fallback_when_conf_disabled(
        spark_tmp_table_factory, format_version, conf_key):
