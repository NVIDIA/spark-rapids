...
import org.apache.iceberg.shaded.org.apache.parquet.io.DelegatingSeekableInputStream;
...
public class ParquetIO {
  ...
  static InputFile file(org.apache.iceberg.io.InputFile file) {
    ...
    if (file instanceof HadoopInputFile) {
      ...
      try {
        return org.apache.iceberg.shaded.org.apache.parquet.hadoop.util.HadoopInputFile
            .fromStatus(hfile.getStat(), hfile.getConf());
      } catch (IOException e) {
