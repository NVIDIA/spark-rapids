...
object QualificationInfoUtils extends Logging {
   ...
   * --jars ./rapids-4-spark-tools/target/rapids-4-spark-tools_2.12-21.06.2-SNAPSHOT-tests.jar,\
   *  ./rapids-4-spark-tools/target/rapids-4-spark-tools_2.12-21.06.2-SNAPSHOT.jar \
   * --class com.nvidia.spark.rapids.tool.profiling.QualificationInfoUtils \
   * ./rapids-4-spark-tools/target/rapids-4-spark-tools_2.12-21.06.2-SNAPSHOT-tests.jar udffunc \
