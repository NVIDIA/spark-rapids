...
sed -n '/object GpuParquetFileFormat/,/^}/{/^}/!p}' spark2-sql-plugin/src/main/scala/com/nvidia/spark/rapids/GpuParquetFileFormat.scala > GpuParquetFileFormat_new.out
sed -n '/object GpuParquetFileFormat/,/^}/{/^}/!p}' sql-plugin/src/main/scala/com/nvidia/spark/rapids/GpuParquetFileFormat.scala > GpuParquetFileFormat_old.out
diff GpuParquetFileFormat_new.out GpuParquetFileFormat_old.out > GpuParquetFileFormat.newdiff
diff -c spark2diffs/GpuParquetFileFormat.diff GpuParquetFileFormat.newdiff

sed -n '/def asDecimalType/,/^  }/{/^  }/!p}' spark2-sql-plugin/src/main/scala/com/nvidia/spark/rapids/DecimalUtil.scala > asDecimalType_new.out
sed -n '/def asDecimalType/,/^  }/{/^  }/!p}' sql-plugin/src/main/scala/com/nvidia/spark/rapids/DecimalUtil.scala > asDecimalType_old.out
diff -c asDecimalType_new.out asDecimalType_old.out
...
diff getPrecisionForIntegralType_new.out getPrecisionForIntegralType_old.out > getPrecisionForIntegralType.newdiff
diff -c spark2diffs/getPrecisionForIntegralType.diff getPrecisionForIntegralType.newdiff
...
sed -n '/def toRapidsStringOrNull/,/^  }/{/^  }/!p}' spark2-sql-plugin/src/main/scala/com/nvidia/spark/rapids/DecimalUtil.scala > toRapidsStringOrNull_new.out
sed -n '/private static DType/,/^  }/{/^  }/!p}' sql-plugin/src/main/java/com/nvidia/spark/rapids/GpuColumnVector.java > toRapidsStringOrNull_old.out
diff toRapidsStringOrNull_new.out toRapidsStringOrNull_old.out > toRapidsStringOrNull.newdiff
diff -c spark2diffs/toRapidsStringOrNull.diff toRapidsStringOrNull.newdiff

sed -n '/def createCudfDecimal/,/^  }/{/^  }/!p}' spark2-sql-plugin/src/main/scala/com/nvidia/spark/rapids/DecimalUtil.scala > createCudfDecimal_new.out
sed -n '/def createCudfDecimal/,/^  }/{/^  }/!p}' sql-plugin/src/main/scala/com/nvidia/spark/rapids/DecimalUtil.scala > createCudfDecimal_old.out
diff createCudfDecimal_new.out createCudfDecimal_old.out > createCudfDecimal.newdiff
diff -c spark2diffs/createCudfDecimal.diff createCudfDecimal.newdiff

sed -n  '/abstract class ReplicateRowsExprMeta/,/^}/{/^}/!p}' spark2-sql-plugin/src/main/scala/com/nvidia/spark/rapids/GpuReplicateRowsMeta.scala > ReplicateRowsExprMeta_new.out
sed -n  '/abstract class ReplicateRowsExprMeta/,/override final def convertToGpu/{/override final def convertToGpu/!p}' sql-plugin/src/main/scala/com/nvidia/spark/rapids/GpuGenerateExec.scala > ReplicateRowsExprMeta_old.out
diff ReplicateRowsExprMeta_new.out ReplicateRowsExprMeta_old.out > ReplicateRowsExprMeta.newdiff
diff -c spark2diffs/ReplicateRowsExprMeta.diff ReplicateRowsExprMeta.newdiff

diff ./spark2-sql-plugin/src/main/scala/com/nvidia/spark/rapids/DateUtils.scala ./sql-plugin/src/main/scala/com/nvidia/spark/rapids/DateUtils.scala > DateUtils.newdiff
diff -c spark2diffs/DateUtils.diff DateUtils.newdiff

sed -n '/object CudfTDigest/,/^}/{/^}/!p}' spark2-sql-plugin/src/main/scala/com/nvidia/spark/rapids/GpuApproximatePercentile.scala > CudfTDigest_new.out
sed -n '/object CudfTDigest/,/^}/{/^}/!p}' sql-plugin/src/main/scala/com/nvidia/spark/rapids/GpuApproximatePercentile.scala > CudfTDigest_old.out
diff CudfTDigest_new.out CudfTDigest_old.out > CudfTDigest.newdiff
diff -c spark2diffs/CudfTDigest.diff CudfTDigest.newdiff

sed -n  '/sealed trait TimeParserPolicy/p' spark2-sql-plugin/src/main/scala/org/apache/spark/sql/rapids/datetimeExpressions.scala > TimeParserPolicy_new.out
sed -n  '/sealed trait TimeParserPolicy/p' sql-plugin/src/main/scala/org/apache/spark/sql/rapids/datetimeExpressions.scala > TimeParserPolicy_old.out
diff -c TimeParserPolicy_new.out TimeParserPolicy_old.out

sed -n  '/object LegacyTimeParserPolicy/p' spark2-sql-plugin/src/main/scala/org/apache/spark/sql/rapids/datetimeExpressions.scala > LegacyTimeParserPolicy_new.out
sed -n  '/object LegacyTimeParserPolicy/p' sql-plugin/src/main/scala/org/apache/spark/sql/rapids/datetimeExpressions.scala > LegacyTimeParserPolicy_old.out
diff -c LegacyTimeParserPolicy_new.out LegacyTimeParserPolicy_old.out

sed -n  '/object ExceptionTimeParserPolicy/p' spark2-sql-plugin/src/main/scala/org/apache/spark/sql/rapids/datetimeExpressions.scala > ExceptionTimeParserPolicy_new.out
sed -n  '/object ExceptionTimeParserPolicy/p' sql-plugin/src/main/scala/org/apache/spark/sql/rapids/datetimeExpressions.scala > ExceptionTimeParserPolicy_old.out
diff -c ExceptionTimeParserPolicy_new.out ExceptionTimeParserPolicy_old.out

sed -n  '/object CorrectedTimeParserPolicy/p' spark2-sql-plugin/src/main/scala/org/apache/spark/sql/rapids/datetimeExpressions.scala > CorrectedTimeParserPolicy_new.out
sed -n  '/object CorrectedTimeParserPolicy/p' sql-plugin/src/main/scala/org/apache/spark/sql/rapids/datetimeExpressions.scala > CorrectedTimeParserPolicy_old.out
diff -c CorrectedTimeParserPolicy_new.out CorrectedTimeParserPolicy_old.out
