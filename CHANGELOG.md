...
|||
|:---|:---|
|[#11830](https://github.com/NVIDIA/spark-rapids/issues/11830)|[FEA] Remove reliance on handle lock to check spillability|
...
|[#10969](https://github.com/NVIDIA/spark-rapids/issues/10969)|[FEA] Support RaiseError for DB 14.3 and Spark 4.0.0|
...
|[#11825](https://github.com/NVIDIA/spark-rapids/issues/11825)|[FEA] Balance the pre-merge CI job's time for the ci_1 and ci_2 tests|
