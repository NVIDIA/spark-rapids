...
|[#661](https://github.com/NVIDIA/spark-rapids/issues/661)|[FEA] CI premerge check should fail if build modifies files in the repository|
|[#1801](https://github.com/NVIDIA/spark-rapids/issues/1801)|[FEA] Integration test jar should include scallop dependency|
|[#1773](https://github.com/NVIDIA/spark-rapids/issues/1773)|[FEA] Spark 3.0.2 release available.|
|[#1460](https://github.com/NVIDIA/spark-rapids/issues/1460)|[FEA] Spark 3.1.0 - pull in [SPARK-32827][SQL] Add spark.sql.maxMetadataStringLength config|
|[#1731](https://github.com/NVIDIA/spark-rapids/issues/1731)|[FEA]  Cancel the running broadcast sub-jobs when SQL statement is cancelled|
...
|[#1736](https://github.com/NVIDIA/spark-rapids/issues/1736)|Random seed changed to handle expression as seed in Spark 3.1|
|[#1690](https://github.com/NVIDIA/spark-rapids/issues/1690)|[FEA] support alternate jar paths in run_pyspark_from_build.sh for integration tests|
...
|[#1517](https://github.com/NVIDIA/spark-rapids/issues/1517)|[FEA] Add tests for Datetimes with bad combination of year/month/day...|
|[#1580](https://github.com/NVIDIA/spark-rapids/issues/1580)|Support Decimal for ParquetCachedBatchSerializer|
|[#1620](https://github.com/NVIDIA/spark-rapids/issues/1620)|[FEA] Automate integration tests for Arrow HostColumnToGpu functionality|
...
|[#1483](https://github.com/NVIDIA/spark-rapids/issues/1483)|[FEA] Do not display rand seed numbers in schema|
...
|[#1479](https://github.com/NVIDIA/spark-rapids/issues/1479)|Fail by default when reading/writing legacy datetime values from/to Parquet/Avro files|
...
|[#1277](https://github.com/NVIDIA/spark-rapids/issues/1277)|[FEA] Update build pipelines for Spark 3.1.0, add pipeline for Spark 3.2.0|
...
|[#959](https://github.com/NVIDIA/spark-rapids/issues/959)|[FEA] Audit_3.0.1: This might affect our Casting string to timestamp|
...
|[#1309](https://github.com/NVIDIA/spark-rapids/issues/1309)|Automated canonicalization tests|
|[#1305](https://github.com/NVIDIA/spark-rapids/issues/1305)|[FEA] Investigate potential GPU expressions of sort order|
