...
public class DecimalFractionGeneric extends GenericUDF implements RapidsUDF {
  private transient PrimitiveObjectInspector inputOI;

  @Override
  public String getDisplayString(String[] strings) {
    return getStandardDisplayString("decimalfractiongeneric", strings);
  }
  ...
  public Object evaluate(DeferredObject[] arguments) throws HiveException {
    ...
    HiveDecimal decimalInput = decimalWritable.getHiveDecimal();
    decimalWritable.set(decimalInput.fractionPortion());
