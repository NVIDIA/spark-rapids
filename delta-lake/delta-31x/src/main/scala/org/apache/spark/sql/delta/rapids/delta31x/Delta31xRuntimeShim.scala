...
import com.nvidia.spark.rapids.delta.delta31x.{Delta31xProvider, GpuDeltaCatalog}
...
class Delta31xRuntimeShim extends DeltaRuntimeShim {
  override def getDeltaProvider: DeltaProvider = Delta31xProvider
