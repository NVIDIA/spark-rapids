...
- [ ] H5: Configuration — New `RapidsConf` keys without documentation
  ...
  sufficiently tested.
- [ ] H6: Magic numbers — Unexplained numeric literals — should be
  named constants or accompanied by comments.
- [ ] H7: Idiomatic Scala — Explicit `return` statements (use last
  expression), Java-style loops where functional combinators fit.
