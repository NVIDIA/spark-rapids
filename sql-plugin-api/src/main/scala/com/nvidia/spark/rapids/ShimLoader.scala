...
/*
    ...
    spark34-common/com/nvidia/spark/rapids/CastExprMeta.class
    ...
    jar:file:/home/spark/rapids-4-spark_2.12-24.08.0.jar!/spark34-common/
...
object ShimLoader extends Logging {
  ...
  private val shimCommonURL = new URL(s"${shimRootURL.toString}spark34-common/")
